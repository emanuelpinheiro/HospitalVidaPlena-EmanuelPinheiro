...
namespace HospitalVidaPlena_EmanuelPinheiro.Controllers
{
    public class AltaHospitalarsController : Controller
    {
        ...
        {
            ViewData["InternacaoId"] = new SelectList(_context.Internacoes, "Id", "Leito");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,InternacaoId,Data,CondicaoPaciente,Instrucoes")] AltaHospitalar altaHospitalar)
        {
            ...
            ViewData["InternacaoId"] = new SelectList(_context.Internacoes, "Id", "Leito", altaHospitalar.InternacaoId);
            return View(altaHospitalar);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,InternacaoId,Data,CondicaoPaciente,Instrucoes")] AltaHospitalar altaHospitalar)
        {
